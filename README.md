...
### Installation
Swissdd can be installed from github as follows: `devtools::install_github("politanch/swissdd", ref="dev")`. Data for Cantonal Votes can currently not be retrieved, due to inconsistencies in the data source.
