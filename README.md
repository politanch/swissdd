...
### Installation
Currently we recommend to install the dev-version from github : `devtools::install_github("politanch/swissdd", ref="dev")`. Data for Cantonal Votes can currently not be retrieved, due to inconsistencies in the data source.
