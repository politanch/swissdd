...
#' # yields the same result as the municipality level, with the exception of Winterthur
#' # and Zurich, where detailed counting district results are returned instead.
#' 
